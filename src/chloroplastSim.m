...
initcond=simparams.initvarsforsim; % Starting values for everything (including LumenProtons,LumenCl...)
...
sim.nsections=length(LightIntensity); % Number of light conditions to iterate through?
